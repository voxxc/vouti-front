...
// INVARIANTE: Esta função sincroniza processos descobertos por OAB usando /requests.
...
// (judit-ativar-monitoramento-oab). Sincronizar OAB jamais consome cota de anexos.
