...
-- 1. Add 'estagiario' to app_role enum
ALTER TYPE public.app_role ADD VALUE IF NOT EXISTS 'estagiario';

-- 2. Recreate get_users_with_roles with estagiario priority
...
-- 3. Recreate get_users_with_roles_by_tenant with estagiario priority
