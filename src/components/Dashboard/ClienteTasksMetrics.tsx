    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <Card className="bg-card hover:shadow-elegant transition-shadow">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-purple-600">{metrics.distribuicaoGeral.emAndamento}</div>
        ...
        <Card className="bg-card hover:shadow-elegant transition-shadow">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-yellow-600">{metrics.distribuicaoGeral.aguardando}</div>
        ...
        <Card className="bg-card hover:shadow-elegant transition-shadow">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-green-600">{metrics.distribuicaoGeral.concluidas}</div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-4">
            {metrics.top5ClientesAtivos.length > 0 ? (
                  ...
                  <div key={cliente.projectId} className="p-4 bg-muted/50 rounded-lg border">
                    <div className="flex items-start justify-between mb-3">
                      <div className="flex items-center gap-2">
                        ...
                        <h4 className="font-semibold text-sm">{cliente.clienteNome}</h4>
                      </div>
                    ...
                    <div className="grid grid-cols-4 gap-3 text-xs">
                      <div className="flex flex-col items-center p-2 bg-purple-50 dark:bg-purple-950/20 rounded border border-purple-200 dark:border-purple-900">
                        ...
                        <span className="font-bold text-purple-600">{cliente.emAndamento}</span>
                      ...
                      <div className="flex flex-col items-center p-2 bg-yellow-50 dark:bg-yellow-950/20 rounded border border-yellow-200 dark:border-yellow-900">
                        ...
                        <span className="font-bold text-yellow-600">{cliente.aguardando}</span>
                      ...
                      <div className="flex flex-col items-center p-2 bg-blue-50 dark:bg-blue-950/20 rounded border border-blue-200 dark:border-blue-900">
                        ...
                        <span className="font-bold text-blue-600">{cliente.aFazer}</span>
                      ...
                      <div className="flex flex-col items-center p-2 bg-green-50 dark:bg-green-950/20 rounded border border-green-200 dark:border-green-900">
                        ...
                        <span className="font-bold text-green-600">{cliente.concluidas}</span>
