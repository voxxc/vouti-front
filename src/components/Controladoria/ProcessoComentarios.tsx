...
import { useProcessoComentarios } from '@/hooks/useProcessoComentarios';
...
interface ProcessoComentariosProps {
  processoId: string | null;
  currentUserId: string;
}

export const ProcessoComentarios = ({ processoId, currentUserId }: ProcessoComentariosProps) => {
  const { comentarios, loading, addComentario, deleteComentario } = useProcessoComentarios(processoId);
